...
<html>
  ...
  <body>
      ...
      <nav class="navbar navbar-dark justify-content-center text-light border yolo">
        ...
        <a class="" href="..">
          ...
          <path d="M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15H1.5zM11 2h.5a.5.5 0 0 1 .5.5V15h-1V2zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z"/>
			...
			<div class="col p-6">
      <div class=koko>
        <h5 style="font-family: 'Acme', sans-serif; float: left">Session: "joueur"</h5>
      </div>
      </div>
    ...
    <br></br>
    <br></br>
    <h2 style="text-align: center; font-family: 'Acme', sans-serif; color: yellow; color: yellow">Liste des Quizz</h2>

  <br></br>
  <a href="drama.html" class="button"><h4 style="font-family: 'Acme', sans-serif; color: yellow">Films Dramatiques</h4></a>
  <a href="action.html" class="button"><h4 style="font-family: 'Acme', sans-serif; color: yellow">Films d'Actions</h4></a>
  <a href="disney.html" class="button"><h4 style="font-family: 'Acme', sans-serif; color: yellow">Films Disney</h4></a>

  <img class="disney" src="disney.png" alt="disney">
  <img class="theatre" src="theatre.png" alt="theatre">
